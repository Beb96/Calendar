...
GregorianCalendar::GregorianCalendar() {
    ...
    // Assegnazione del mese corrente
    current_month = list_month.at(getInitMonth()).toLocal8Bit().constData();

    // Assegnazione dell'anno corrente
    current_year = getInitYear();

    // Assegnazione dell'anno iniziale e finale della lista
    first_year = current_year - 5;
    last_year = current_year + 5;

    // Costruzione della lista degli anni
